...
var vdom = function vdom() {
    return vnode(
        ...
        vnode(
            ...
            vnode("img", { src: "https://imgsrc.baidu.com/baike/pic/item/95eef01f3a292df50b2907f0b2315c6035a87369.jpg", height: "56", style: "border: none; margin: 8px 0px;", onClick: addCount }),
            "hello ym ",
            count
        )
    );
